...
describe('MeanWorkloadByUser.vue', () => {
        ...
        charts: [
          {
            ...
            "chartOptions": {
              ...
              "title": {
                "text": "Quantidade de minutos trabalhados por dia - Milena Matos",
                "align": "left"
              },
              "markers": {
                "size": 1
              ...
              "yaxis": {
                ...
                "labels": {
                  ...
                  "formatter": {
                    "_custom": {
                      "type": "function",
                      "display": "<span style=\"opacity:.5;\">function</span> formatter(val)",
                      "tooltip": "<pre>function formatter(val) {\n              return val + \" minutos\";\n            }</pre>",
                      "_reviveId": 7
                    }
                  }
                }
  ...
  it('renders v-components', () => {
    ...
    expect(wrapper.findAllComponents({ name: 'v-expansion-panel' }).length).toBe(1)
  })
